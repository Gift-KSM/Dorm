...
class DetailsPimrada extends StatelessWidget {
  @override
                ...
                Container(
                  ...
                  child: ImageSlideshow(
                    ...
                    children: [
                      ...
                      Image.asset(
                        'assets/img/Dorm/pimrada1.jpg',
                        fit: BoxFit.cover,
                      ),
                      Image.asset(
                        'assets/img/Dorm/pimrada2.jpg',
                        fit: BoxFit.cover,
                      ),
                      Image.asset(
                        'assets/img/Dorm/pimrada3.jpg',
                        fit: BoxFit.cover,
                      ),
                      Image.asset(
                        'assets/img/Dorm/pimrada4.jpg',
                        fit: BoxFit.cover,
                      ),
                      Image.asset(
                        'assets/img/Dorm/pimrada5.jpg',
                        fit: BoxFit.cover,
                      ),
                    ],
                    onPageChanged: (value) {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      RichText(
                        text: TextSpan(
                          text:
                              '- หอพักรายเทอม ราคา 18,000 บาท/เทอม\n- ค่าไฟ 7.5 บาท/หน่วย\n- ค่าน้ำ คนละ100 บาท /เดือน\n- ค่าเน็ต 150 บาท/เดือน',
                          style: TextStyle(
                            fontFamily: 'Mitr',
                            color: black.withOpacity(1.0),
                            fontSize: 16.0,
