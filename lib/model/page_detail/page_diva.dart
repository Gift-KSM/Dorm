...
class DetailsDiva extends StatelessWidget {
  @override
                ...
                Container(
                  ...
                  child: ImageSlideshow(
                    ...
                    children: [
                      ...
                      Image.asset(
                        'assets/img/Dorm/diva1.jpg',
                        fit: BoxFit.cover,
                      ),
                      Image.asset(
                        'assets/img/Dorm/diva2.jpg',
                        fit: BoxFit.cover,
                      ),
                      Image.asset(
                        'assets/img/Dorm/diva3.jpg',
                        fit: BoxFit.cover,
                      ),
                      Image.asset(
                        'assets/img/Dorm/diva4.jpg',
                        fit: BoxFit.cover,
                      ),
                      Image.asset(
                        'assets/img/Dorm/diva5.jpg',
                        fit: BoxFit.cover,
                      ),
                    ],
                    onPageChanged: (value) {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      RichText(
                        text: TextSpan(
                          text:
                              '- หอพักรายเทอม ราคา 14,000 บาท/เทอม\n- ค่าไฟ หน่วยละ 8 บาท\n- ค่าน้ำ 100 บาท/เดือน\n- ฟรีอินเทอร์เน็ต',
                          style: TextStyle(
                            fontFamily: 'Mitr',
                            color: black.withOpacity(1.0),
                            fontSize: 16.0,
